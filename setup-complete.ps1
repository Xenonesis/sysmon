...
Write-Host "[OK] Application Status:" -ForegroundColor Green
...
Write-Host "[OK] Features Available:" -ForegroundColor Green
...
Write-Host "[WARN] Important Notes:" -ForegroundColor Yellow
