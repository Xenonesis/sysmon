...
pub(crate) fn show(app: &mut crate::SystemMonitorApp, ui: &mut egui::Ui) {
    ...
    egui::ScrollArea::vertical().show(ui, |ui| {
            ...
            ui.group(|ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    if elevated {
                        ...
                        if ui.button("🛡 Relaunch as Administrator").clicked() && crate::privilege::relaunch_as_admin()
                        {
        ...
        ui.group(|ui| {
            ...
            ui.label(
                egui::RichText::new("Save current system snapshot to a file")
                    .size(11.0)
        ...
        ui.group(|ui| {
            ui.set_width(ui.available_width());
            ui.heading("Safety and Audit");
            ui.label("System-changing actions require a risk preview and are recorded locally.");
